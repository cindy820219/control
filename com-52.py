...
def animate(i):
    ...
    #~ ----------------------------------------------------------------
    #~ 01
    graph_data01 = open('Jan11_CO2_13.txt','r').read()
    ...
    #~ 02
    graph_data02 = open('Jan11_CO2_18.txt','r').read()
    ...
    #~ 03
    graph_data03 = open('Jan11_CO2_17.txt','r').read()
    ...
    #~ 04
    graph_data04 = open('Jan11_CO2_23.txt','r').read()
    ...
    #~ 05
    graph_data04 = open('Jan11_CO2_22.txt','r').read()
    lines = graph_data04.split('\n')
    x05 = []
    y05 = []
    for line in lines:
