...
def animate(i):
    ...
    #~ ----------------------------------------------------------------
    #~ 01 
    graph_data01 = open('Jan11_CO2_5.txt','r').read()
    ...
    #~ 02
    graph_data02 = open('Jan11_CO2_24.txt','r').read()
    ...
    #~ 03
    graph_data03 = open('Jan11_CO2_20.txt','r').read()
    ...
    #~ 04
    graph_data04 = open('Jan11_CO2_19.txt','r').read()
    ...
    #~ 05
    graph_data04 = open('Jan11_CO2_21.txt','r').read()
    lines = graph_data04.split('\n')
    x05 = []
    y05 = []
    for line in lines:
